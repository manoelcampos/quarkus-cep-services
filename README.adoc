...
- Documentação do WELD: Implementação de Referência do CDI
    * https://docs.jboss.org/weld/reference/latest/en-US/html/intro.html#_what_is_a_bean[What is a bean]
...
- Documentação Oficial da Oracle (apesar de ser pra Java 7, continua válida)
    * https://docs.oracle.com/javaee/7/tutorial/cdi-basic008.htm[The Java EE 7 Tutorial: Using Scopes]
